<?php
function documentady($key_api, $host_key, $language, $key_gen, $genre, $urlImage, $width){
    ...
    documentadyTamb($res->results, $urlImage, $width);
}  

function documentadyTamb($result, $urlImage, $width){
