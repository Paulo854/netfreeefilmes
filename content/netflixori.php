<?php
function netflixOrig($key_api, $host_key, $language, $key_gen, $genre, $urlImage, $width){
    ...
    netFlixOrigTamb($res->results, $urlImage, $width);
}  

function netFlixOrigTamb($result, $urlImage, $width){
